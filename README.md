...
1. **Wrong college info** → Only pre-verified data is used
2. **No internet** → Predefined answers for common questions
3. **Student location queries** → Campus map with exact locations
4. **Online admissions** → Form accessible without visiting college
5. **Outdated data** → Update `data/collegeData.js` annually
6. **Authentication** → Session-based, expires in 24 hours
